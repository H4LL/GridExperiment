...
gridexperiment_bill_1 = pd.read_csv('results/graphs/gridexperiment_bill_1/blockinput.csv', delimiter=' ', names=['val'])
gridexperiment_alice_1 = pd.read_csv('results/graphs/gridexperiment_alice_1/blockinput.csv', delimiter=' ', names=['val'])
gridexperiment_bob_1 = pd.read_csv('results/graphs/gridexperiment_bob_1/blockinput.csv', delimiter=' ', names=['val'])
gridexperiment_gateway_1 = pd.read_csv('results/graphs/gridexperiment_gateway_1/blockinput.csv', delimiter=' ', names=['val'])
