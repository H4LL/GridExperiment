...
# load cpu data
gridexperiment_james_1 = pd.read_csv('results/graphs/gridexperiment_james_1/blockoutput.csv', delimiter=' ', names=['val'])
gridexperiment_bill_1 = pd.read_csv('results/graphs/gridexperiment_bill_1/blockoutput.csv', delimiter=' ', names=['val'])
gridexperiment_alice_1 = pd.read_csv('results/graphs/gridexperiment_alice_1/blockoutput.csv', delimiter=' ', names=['val'])
gridexperiment_bob_1 = pd.read_csv('results/graphs/gridexperiment_bob_1/blockoutput.csv', delimiter=' ', names=['val'])
gridexperiment_gateway_1 = pd.read_csv('results/graphs/gridexperiment_gateway_1/blockoutput.csv', delimiter=' ', names=['val'])
